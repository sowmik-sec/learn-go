...
func EncodeJson() {
	lcoCourses := []course{
		{
			"ReactJS Bootcamp", 299, "learn.com", "asdf", []string{"web-dev", "js"},
		},
		{
			"MERN Bootcamp", 299, "learn.com", "asdf", []string{"web-dev", "js"},
		},
		{
			"Go Bootcamp", 299, "learn.com", "asdf", []string{"web-dev", "go"},
		},
	}
